...
class MobileDesktopDev extends StatefulWidget {
  const MobileDesktopDev({super.key});

  @override
  State<MobileDesktopDev> createState() => _MobileDesktopDevState();
}

class _MobileDesktopDevState extends State<MobileDesktopDev>
{
  var formKey = GlobalKey<FormState>();
  late TextEditingController NameController;
  late TextEditingController EmailController;
  late String packageName;
  String MobileIosAndroid ="Android or IOS Package";
  String CrossPlatformApp ="All Devices APP Package";
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: MaterialButton(
                                            ...
                                            {
                                              setState(() {
                                                packageName = MobileIosAndroid.toString();
                                                getServiceBtn();
                                              });
                                            },
                                            color: Colors.purple,
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: MaterialButton(
                                            ...
                                            {
                                              setState(() {
                                                packageName = CrossPlatformApp.toString();
                                                getServiceBtn();
                                              });
                                            },
                                            color:  Color.fromARGB(255, 184, 134, 11),
